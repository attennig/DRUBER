                ...
                for seed in seeds:
                    for algo in algorithms:
                        ...
                        if os.path.exists(in_file):
                            ...
                            fd.write(f'{ns},{nd},{nu},{seed},{algo},{data["completion_time"]},{data["mean_schedule_time"]},{data["mean_flight_time"]},{data["mean_swap_time"]},{data["mean_waiting_time"]}, {data["mean_delivery_time"]},{data["mean_schedule_distance"]},{data["mean_schedule_energy"]},{data["mean_number_swaps"]},{data["drone_utilization_time"]},{data["drone_utilization"]},{data["total_number_parcel_handover"]},{data["mean_number_parcel_handover"]},{data["execution_time"]}\n')
