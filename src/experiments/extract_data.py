...
with open(out_file_name, 'w') as fd:
    fd.write("nstations,ndeliveries,ndrones,seed,algorithm,completion_time,mean_schedule_time,mean_flight_time,mean_swap_time,mean_idle_time,mean_delivery_time,mean_schedule_distance,mean_schedule_energy,mean_number_swaps,drone_utilization,total_number_parcel_handover,mean_number_parcel_handover,execution_time\n")
                ...
                for seed in seeds:
                    for algo in algorithms:
                        ...
                        if os.path.exists(in_file):
                            ...
                            fd.write(f'{ns},{nd},{nu},{seed},{algo},{data["completion_time"]},{data["mean_schedule_time"]},{data["mean_flight_time"]},{data["mean_swap_time"]},{data["mean_idle_time"]}, {data["mean_delivery_time"]},{data["mean_schedule_distance"]},{data["mean_schedule_energy"]},{data["mean_number_swaps"]},{data["drone_utilization"]},{data["total_number_parcel_handover"]},{data["mean_number_parcel_handover"]},{data["execution_time"]}\n')
