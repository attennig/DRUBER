...
parser.add_argument("-in", dest='in_path', action="store", type=str,
...
for seed in range(args.initial_seed, args.end_seed):
    S = Simulator(seed,args.number_of_stations, args.number_of_deliveries, args.number_of_drones, args.in_path, args.out_path)
    S.loadScenario()
